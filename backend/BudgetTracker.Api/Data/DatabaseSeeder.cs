    ...
    public static class DatabaseSeeder
    {
        public static void Seed(BudgetTrackerContext context)
        {
            ...
            var transactions = new List<Transaction>
            {
                ...
                new Transaction { Id = Guid.NewGuid(), Date = new DateTime(2025, 12, 8), Description = "TfL", Amount = -11.40m, Category = "Transport", AccountName = "Current Account" },
                ...
                new Transaction { Id = Guid.NewGuid(), Date = new DateTime(2026, 1, 9), Description = "TfL", Amount = -10.80m, Category = "Transport", AccountName = "Current Account" },
                ...
                new Transaction { Id = Guid.NewGuid(), Date = new DateTime(2026, 2, 8), Description = "TfL", Amount = -9.60m, Category = "Transport", AccountName = "Current Account" },
                ...
                new Transaction { Id = Guid.NewGuid(), Date = new DateTime(2026, 3, 7), Description = "TfL", Amount = -12.20m, Category = "Transport", AccountName = "Current Account" },
